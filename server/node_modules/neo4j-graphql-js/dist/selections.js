...
function buildCypherSelection(_ref) {
  ...
  var schemaTypeField = !isScalarSchemaType ? schemaType.getFields()[fieldName] : {};
  ...
  if ((0, _utils.isGraphqlScalarType)(innerSchemaType)) {
    if (customCypher) {
      ...
      return recurse((0, _extends3.default)({
        initial: '' + initial + fieldName + ': apoc.cypher.runFirstColumn("' + customCypher + '", {' + (0, _utils.cypherDirectiveArgs)(variableName, headSelection, cypherParams, schemaType, resolveInfo, paramIndex) + '}, false)' + commaIfTail
      }, tailParams));
